...
![](./Seata.assets/image-4.png)

* 新建配置

![](./Seata.assets/image-5.png)

此处 dataId 为 seataServer.properties

![](./Seata.assets/image-6.png)
...
![](./Seata.assets/image.png)

同时在nacos上能看到有一个seata的服务注册上去了：

![](./Seata.assets/image-1.png)
